...
import rpgcore.skills.InfinityTerminus;

public class InfinityTerminusE
{
	public static ArrayList<InfinityTerminusE> effects = new ArrayList<InfinityTerminusE>();
	public static ArrayList<InfinityTerminusE> remove = new ArrayList<InfinityTerminusE>();
	...
	public InfinityTerminusE(InfinityTerminus skill, LivingEntity target)
	{
		this.skill = skill;
		this.target = target;
	...
	{
		for (InfinityTerminusE e: effects)
			e.tick();
		effects.removeAll(InfinityTerminusE.remove);
		remove.clear();
	}
}
